...
$(document).ready(function(){
	{params}
	var modenum = 'knowledge',modename='知识',isflow=0,modeid='40',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"title","name":"\u6807\u9898","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"typeid","name":"\u5bf9\u5e94\u5206\u7c7b","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"sort","name":"\u6392\u5e8f","fieldstype":"number","ispx":"0","isalign":"0","islb":"0"},{"fields":"content","name":"\u5185\u5bb9","fieldstype":"htmlediter","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'知识('+nowtabs.name+')',
				cont:'知识('+nowtabs.name+')的列表的',
				explain:'订阅[知识]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_knowledge|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistknowledge = a;
			addtabs({num:'daoruknowledge',url:'flow,input,daoru,modenum=knowledge',icons:'plus',name:'导入知识'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('a25vd2xlZGdl'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"标题",dataIndex:"title"},{text:"对应分类",dataIndex:"typeid"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewknowledge_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewknowledge_{rand}"></div>
<!--HTMLend-->