...
$(document).ready(function(){
	{params}
	var modenum = 'dailyflow',modename='工作日报',isflow=1,modeid='80',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_dailyflow|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistdailyflow = a;
			addtabs({num:'daorudailyflow',url:'flow,input,daoru,modenum=dailyflow',icons:'plus',name:'导入工作日报'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewdailyflow_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewdailyflow_{rand}"></div>
<!--HTMLend-->